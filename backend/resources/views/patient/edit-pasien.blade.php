...
<div class="sv-page-header sv-animate-in">
    <div>
        ...
        <p>Memperbarui informasi rekam medis pasien: <strong>{{ $patient->patient_name }}</strong></p>
    </div>
...
<form action="{{ route('admin.patients.update', $patient->patient_id) }}" method="POST" id="editPatientForm">
    @csrf
    @method('PUT')
    <div class="row g-3">
            ...
            <div class="form-section h-100 mb-0">
                ...
                <div class="form-section-body">
                    <div class="mb-0">
                        ...
                        <input type="text" id="patient_id" class="form-control" style="background:#F2F4F7;color:#636366;" value="{{ $patient->patient_id }}" readonly>
                ...
                <div class="form-section-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nik_dummy" id="nik_dummy" class="form-control" placeholder="Masukkan 16 digit NIK" value="{{ old('nik_dummy', $patient->nik_dummy) }}" required pattern="\d{16}">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="tel" name="family_phone" id="family_phone" class="form-control" placeholder="Contoh: 081234xxxxxx" value="{{ old('family_phone', $patient->family_phone) }}" required>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 sv-animate-in sv-animate-in-3 mt-4">
            <div class="d-flex justify-content-end gap-2">
                <a href="{{ route('admin.patients.index') }}" class="btn btn-outline-secondary">Batal</a>
